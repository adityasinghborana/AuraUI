...
class AuraUIParallexCarousel extends StatefulWidget {
  const AuraUIParallexCarousel(
      {super.key,
  ...
  @override
  State<AuraUIParallexCarousel> createState() => _AuraUIParallexCarouselState();
}

class _AuraUIParallexCarouselState extends State<AuraUIParallexCarousel> {
